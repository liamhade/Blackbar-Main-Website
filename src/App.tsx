	...
	return (
		...
		<header className="sticky top-0 z-40 border-b border-gray-200 bg-white/90 backdrop-blur">
			...
			<nav className="hidden gap-6 text-sm md:flex">
				...
				<a href="#photoshield" className="hover:text-gray-700">PhotoShield</a>
		...
		<section className="relative overflow-hidden">
			...
			<div>
				...
				<a href="#photoshield" className="rounded-xl border border-gray-300 px-4 py-2 hover:bg-gray-50">See PhotoShield</a>
				</div>
			</div>
			<div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
				...
				<div className="rounded-xl border border-gray-200 p-4">
					<h3 className="text-sm font-medium">PhotoShield – Threat Detection</h3>
		...
		<section id="platform" className="border-t border-gray-200 bg-white">
			...
			<div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
				...
				<div className="rounded-2xl border border-gray-200 p-6">
				<h3 className="text-xl font-medium">PhotoShield – Intelligent Threat Detection</h3>
				<ul className="mt-4 space-y-2 text-gray-600">

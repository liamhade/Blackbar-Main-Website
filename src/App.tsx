export function App() {
	return (
		...
		<section className="relative overflow-hidden">
			...
			<div className="rounded-2xl border border-gray-300 bg-[var(--container-bg)] p-6 shadow-sm">
				<div className="grid grid-cols-2 gap-4">
				<div className="rounded-xl border border-gray-200 p-4">
					<h3 className="text-sm font-medium text-[var(--text-heading)]">Blackbar Application Privacy Controls</h3>
					<p className="mt-2 text-sm text-[var(--text-secondary)]">Real‑time masking/redaction of PII and sensitive data on the endpoint—no code changes required.</p>
				</div>
				<div className="rounded-xl border border-gray-300 bg-[var(--container-bg)] p-4">
					<h3 className="text-sm font-medium text-[var(--text-heading)]">Blackbar – Threat Detection</h3>
					<p className="mt-2 text-sm text-[var(--text-secondary)]">Detects phones/cameras & multiple viewers; blocks the screen and logs events instantly.</p>
				</div>
				<div className="rounded-xl border border-gray-300 bg-[var(--container-bg)] p-4">
					<h3 className="text-sm font-medium text-[var(--text-heading)]">Cloud‑Managed</h3>
					<p className="mt-2 text-sm text-[var(--text-secondary)]">Central policy console with low‑bandwidth telemetry, SIEM forwarding, and audit trails.</p>
				</div>
				<div className="rounded-xl border border-gray-300 bg-[var(--container-bg)] p-4">
					<h3 className="text-sm font-medium text-[var(--text-heading)]">Enterprise‑Ready</h3>
					<p className="mt-2 text-sm text-[var(--text-secondary)]">AES‑256 at rest, TLS in transit, privacy by design—no continuous video recording.</p>
				</div>
				</div>
			</div>
			{/* Video Section */}
		...
		<section id="platform" className="border-t border-gray-200 bg-[var(--section-bg-primary)]">
			...
			<div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
				<div className="rounded-2xl border border-gray-300 bg-[var(--container-bg)] p-6">
		...
		<section id="solutions" className="border-t border-gray-200 bg-[var(--section-bg-primary)]">
			...
			<div className="mt-10 rounded-2xl border border-gray-300 bg-[var(--container-bg)] p-6">
		...
		<section id="resources" className="border-t border-gray-200 bg-[var(--section-bg-primary)]">
			...
			<ul className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
				<li className="rounded-xl border border-gray-300 bg-[var(--container-bg)] p-4">
		...
		<section id="contact" className="border-t border-gray-200 bg-[var(--section-bg-primary)]">
			...
			<div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
				...
				<form className="rounded-2xl border border-gray-300 bg-[var(--container-bg)] p-6">

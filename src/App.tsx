...
export function App() {
	return (
		...
		{/* Header */}
		<header className="sticky top-0 z-40 bg-[var(--section-bg-secondary)]/90 backdrop-blur">
			...
			<div className="flex items-center gap-3">
				<a href="#investors" className="rounded-xl border border-[var(--border-color)] px-3 py-2 text-sm hover:bg-[var(--secondary-button-hover)]">Investors</a>
		...
		<section className="relative overflow-hidden">
			...
			<div className="max-w-3xl">
				...
				<a href="#blackbar-video" className="rounded-xl border border-[var(--border-color)] px-4 py-2 hover:bg-[var(--secondary-button-hover)]">See Blackbar</a>
				</div>
		...
		{/* Platform Overview */}
		<section id="platform" className=" border-gray-200 bg-[var(--section-bg-secondary)]">
		...
		{/* Product Detail */}
		<section id="product" className=" border-gray-200 bg-[var(--section-bg-primary)]">
			<div className="mx-auto max-w-7xl px-6 py-16">
			...
			<div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-3">
				<div className="rounded-xl border border-[var(--border-color)] bg-[var(--container-bg-secondary)] p-6">
				<h4 className="font-medium text-[var(--text-heading)]">Real‑Time Monitoring</h4>
				<p className="mt-2 text-sm text-[var(--text-secondary)]">Monitors only when policies say: specific apps, URLs, or VPN sessions. No continuous video recording—only event stills with faces blurred.</p>
				</div>
				<div className="rounded-xl border border-[var(--border-color)] bg-[var(--container-bg-secondary)] p-6">
				<h4 className="font-medium text-[var(--text-heading)]">Automatic Response</h4>
				<p className="mt-2 text-sm text-[var(--text-secondary)]">Instantly blocks the screen, displays deterrence overlays, and routes alerts to your SOC/SIEM with full metadata.</p>
				</div>
				<div className="rounded-xl border border-[var(--border-color)] bg-[var(--container-bg-secondary)] p-6">
				<h4 className="font-medium text-[var(--text-heading)]">Enterprise Deployment</h4>
				<p className="mt-2 text-sm text-[var(--text-secondary)]">MSI installer; deploy via Intune/SCCM. Minimal CPU and bandwidth footprint; webcam required.</p>
				</div>
			</div>
			</div>
		</section>
		...
		{/* Solutions / Use Cases */}
		<section id="solutions" className=" border-gray-200 bg-[var(--section-bg-secondary)]">
			<div className="mx-auto max-w-7xl px-6 py-16">
			...
			<div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
				...
				<p className="mt-2 text-sm text-[var(--text-secondary)]">Safely extend access to data‑rich legacy apps without changing them—mask what offshore users can see.</p>
				</div>
			</div>
			<div className="mt-10 rounded-2xl border border-[var(--border-color)] bg-[var(--container-bg-primary)] p-6">
				<h4 className="text-lg font-medium text-[var(--text-heading)]">Use-Case Example</h4>
				<p className="mt-2 text-sm text-[var(--text-secondary)]">Deployed for contingent worker monitoring across vendor ODCs; role‑based policies, incident logging, and phased rollout options.</p>
				<ul className="mt-4 list-disc pl-5 text-sm text-[var(--text-secondary)]">
		...
		{/* Compliance & Security */}
		<section id="compliance" className=" border-gray-200 bg-[var(--section-bg-primary)]">
			<div className="mx-auto max-w-7xl px-6 py-16">
			...
			<div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
				<div className="rounded-2xl border border-[var(--border-color)] bg-[var(--container-bg-secondary)] p-6">
				<h3 className="font-medium text-[var(--text-heading)]">Encryption & Transport</h3>
				<p className="mt-2 text-sm text-[var(--text-secondary)]">AES‑256 for data at rest and TLS 1.2+ for all communications. Single images per event; faces blurred.</p>
				</div>
				<div className="rounded-2xl border border-[var(--border-color)] bg-[var(--container-bg-secondary)] p-6">
				<h3 className="font-medium text-[var(--text-heading)]">Governance Alignment</h3>
				<p className="mt-2 text-sm text-[var(--text-secondary)]">Designed to align with GDPR, SOC 2, and ISO 27001. Role‑based access in the management console with immutable audit trails.</p>
				</div>
			</div>
			<div className="py-5">
				<div className="rounded-2xl border border-[var(--border-color)] bg-[var(--container-bg-secondary)] p-6">
				<h3 className="font-medium text-[var(--text-heading)]">Patented Technology</h3>
				<ul className="mt-2 text-[var(--text-secondary)]">
					<li>• U.S. Patent No. 18/207,840</li>
					<li>• “Method, System, and Techniques for Preventing Analog Data Loss”</li>
					<li>• Assignee: Defy Photo Shield, LLC</li>
					<li>• Overview: PhotoShield's patented technology prevents analog data loss by detecting and mitigating unauthorized visual access to information displayed on computer monitors.</li>
				</ul>
				</div>
			</div>
			</div>
		...
		{/* Resources */}
		<section id="resources" className=" border-gray-200 bg-[var(--section-bg-secondary)]">
			<div className="mx-auto max-w-7xl px-6 py-16">
			...
			<ul className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
				<li className="rounded-xl border border-[var(--border-color)] bg-[var(--container-bg-primary)] p-4">
				<h4 className="font-medium text-[var(--text-heading)]">PhotoShield – Installation Guide</h4>
				<p className="mt-1 text-sm text-[var(--text-secondary)]">Endpoint requirements, MSI install steps, and agent configuration.</p>
				</li>
				<li className="rounded-xl border border-[var(--border-color)] bg-[var(--container-bg-primary)] p-4">
				<h4 className="font-medium text-[var(--text-heading)]">Platform – Technical Overview</h4>
				<p className="mt-1 text-sm text-[var(--text-secondary)]">Architecture, policies, masking rules, and deployment options.</p>
				</li>
			</ul>
			</div>
		</section>
		...
		{/* Investors */}
		<section id="investors" className="border-gray-200 bg-[var(--section-bg-primary)]">
			<div className="mx-auto max-w-7xl px-6 py-16">
		...
		{/* Contact */}
		<section id="contact" className=" border-gray-200 bg-[var(--section-bg-secondary)]">
			<div className="mx-auto max-w-7xl px-6 py-16">
			...
			<div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
				...
				<p className="mt-2 text-sm text-[var(--text-secondary)]">info@blackbar.ai</p>
				<p className="mt-1 text-sm text-[var(--text-secondary)]">Partnerships & Channels</p>
				<p className="text-sm text-[var(--text-secondary)]">partners@blackbar.ai</p>
				</div>
				<form className="rounded-2xl border border-[var(--border-color)] bg-[var(--container-bg-primary)] p-6">
				<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
					<input placeholder="First name" className="rounded-lg border border-[var(--border-color)] px-3 py-2 outline-none focus:ring-2 focus:ring-gray-200" />
					<input placeholder="Last name" className="rounded-lg border border-[var(--border-color)] px-3 py-2 outline-none focus:ring-2 focus:ring-gray-200" />
					<input placeholder="Work email" className="rounded-lg border border-[var(--border-color)] px-3 py-2 outline-none focus:ring-2 focus:ring-gray-200 md:col-span-2" />
					<textarea placeholder="How can we help?" rows={4} className="rounded-lg border border-[var(--border-color)] px-3 py-2 outline-none focus:ring-2 focus:ring-gray-200 md:col-span-2" />
				</div>
		...
		{/* Footer */}
		<footer className=" border-gray-200 bg-[var(--section-bg-secondary)]">
